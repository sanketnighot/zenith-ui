    ...
    <div className="w-[442px] h-[748px] bg-sidebar-bg dark:bg-white dark:text-black px-10 py-14 flex flex-col gap-7">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          <p className="font-black text-[15px] text-[#797979] dark:text-black/70">
            Position size
          </p>
      ...
      <div className="flex flex-col gap-5">
        <div className="flex items-center justify-between">
          ...
          <div className="text-white dark:text-black font-semibold text-[13px]">
            0 USDt
          </div>
        </div>
        <div className="flex items-center justify-between">
      ...
      <button
        className={`${
          ["Long", "Increase"].includes(title) ? "bg-green-btn" : "bg-red-btn"
